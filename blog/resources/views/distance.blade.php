...
<body>
<div class="x-body">
    <form class="layui-form" id="data" action="/updateDistance">

        <div class="layui-form-item">
            <label for="L_email" class="layui-form-label" style="width:138px">
                <span class="x-red">*</span>上班打卡距离
            </label>
        ...
        <div class="layui-form-item">
            <label for="L_username" class="layui-form-label" style="width:138px">
                <span class="x-red">*</span>工作打卡距离
            </label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label for="L_username" class="layui-form-label" style="width:138px">
                <span class="x-red">*</span>隔几分钟记录用户坐标
            </label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            ...
            <input type="submit" class="layui-btn" value="修改" style="margin-left: 55px;">
        </div>
        @if(session('error'))

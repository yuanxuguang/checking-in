  ...
  <body>
    <div class="x-body">
        <form class="layui-form" id="data" >
            ...
            <div class="layui-form-item employer_type changeLabel" >
                    <label for="username" class="layui-form-label">
    ...
    <script>
        ...
        window.onload = function(){
            $("#up1_label").change(function(){  //一级下是否有二级
                ...
                $('#up2_label option[value != 0]').remove();
                $.get({
                    url:'/getLevel2Label',
                    data:{'lid':lid},
                    dataType: 'json',
                    success:function(res){
                        ...
                        if($.isEmptyObject(res)){
                            ...
                            for(var i in res){
                                ...
                                $('#up2_label option[value != 0 && value !=res[i].id').remove();
                            }
                        }
                    }
                })
            ...
            $("#up2_label").change(function(){  //二级是否有三级
                var lid = $(this).children('option:selected').val();
                $('#up3_label option[value != 0]').remove(); // up3_label下不等于0 的清空,避免数据重复
                $.get({
                    url:'/getLevel2Label',
                    data:{'lid':lid},
                    dataType: 'json',
                    success:function(res){
                        ...
                        if($.isEmptyObject(res)){
                            ...
                            for(var i in res){
                                ...
                                $('#up3_label option[value != 0 && value !=res[i].id').remove();
                            }
                        }
                    }
                })
            ...
            $("#up3_label").change(function(){  //三级是否有四级
                var lid = $(this).children('option:selected').val();
                $('#up4_label option[value != 0]').remove(); // up3_label下不等于0 的清空,避免数据重复
                $.get({
                    url:'/getLevel2Label',
                    data:{'lid':lid},
                    dataType: 'json',
                    success:function(res){
                        ...
                        if($.isEmptyObject(res)){
                            ...
                            for(var i in res){
                                ...
                                $('#up4_label option[value != 0 && value !=res[i].id').remove();
